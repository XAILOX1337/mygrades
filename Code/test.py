...
class Application(App):
    ...
    def look_subject(self, instance):
        ...
        records = c.fetchall()
        lab = Label(text = f'Ваши оценки по предмету {instance.text}',font_size=30, 
                    size_hint=(1, None), 
                    height=40,
                    padding=10,
                    )
    ...
    def on_change_grade(self, instance, subject, id_of_grade):
        popup = Popup(title='Изменить оценку', size_hint=(None, None), size=(400, 200))
        
        layout = BoxLayout(orientation='vertical', padding=10, spacing=10)
        
        label = Label(text='Введите новую оценку:')
    ...
    def build(self):
        ...
        self.label=Label(text='', font_size=25,size_hint=(1,0.12))
